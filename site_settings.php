		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label"><b>System Name</b></label>
				...
				<div class="form-group">
					<label for="contact" class="control-label"><b>Contact</b></label>
					<input type="text" class="form-control" id="contact" name="contact" value="<?php echo isset($meta['contact']) ? $meta['contact'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="about" class="control-label"><b>About Content</b></label>
				...
				<center>
					<button class="btn btn-info btn-warning btn-block col-md-2"><b>Save</b></button>
				</center>
			</form>
		</div>
	</div>
