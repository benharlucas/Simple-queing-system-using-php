...
<a href="index.php" class="btn btn-sm btn-success"><i class="fa fa-home"></i> <b>Home</b></a>
<div class="left-side">
				...
				<div class="container-fluid">
					<form action="" id="new_queue">
						<div class="form-group">
							<label for="name" class="control-label"><b>Full Name</b></label>
							<input type="text" id="name" name="name" class="form-control">
						</div>
						<div class="form-group">
							<label for="transaction_id" class="control-label"><b>Type of Transactions</b></label>
						...
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-warning col-md-3 float-right"><b>Save<b></button>
							</div>
						</div>
					</form>
				</div>
