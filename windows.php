			...
			<form action="" id="manage-window">
				<div class="card">
					...
					<div class="card-body">
						<div id="msg"></div>
							...
							<div class="form-group">
								<label class="control-label"><b>Transaction</b></label>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-warning col-sm-3 offset-md-3"><b>Save</b></button>
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()"> <b>Cancel</b></button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-warning edit_window" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-transaction_id="<?php echo $row['transaction_id'] ?>"  >Edit</button>
										<button class="btn btn-sm btn-danger delete_window" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
